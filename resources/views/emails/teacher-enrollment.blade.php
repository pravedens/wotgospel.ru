...
<head>
    ...
    <style>
        ...
        .message-box { background: white; padding: 20px; border-radius: 8px; border-left: 4px solid #3b82f6; margin: 20px 0; white-space: pre-wrap; }
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div style="text-align: center;">
                <a href="{{ $dashboardUrl }}" class="button">📋 Перейти к заявкам</a>
            </div>
        </div>
        <div class="footer">
