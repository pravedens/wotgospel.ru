    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->filled('church_name')) {
                $updateData['church_name'] = $request->church_name;
            }
            ...
            if ($request->filled('ministry')) {
                $updateData['ministry'] = $request->ministry;
            }
            if ($request->filled('bible_courses_experience')) {
                $updateData['bible_courses_experience'] = $request->bible_courses_experience;
            }
            if ($request->filled('learning_expectations')) {
                $updateData['learning_expectations'] = $request->learning_expectations;
            }
